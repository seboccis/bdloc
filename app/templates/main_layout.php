...
<body>
	<div class="container">
		...
		<div id='shadow'>
			<div id="lightBox" data-ajax-catalog-getDetail-path="<?php echo $this->url('ajax_catalog_detail'); ?>" data-ajax-submit-order-path="<?php echo $this->url('ajax_submit_order'); ?>"></div>
		</div>
